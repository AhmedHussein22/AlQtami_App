...
class CustomListTile extends StatelessWidget {
  ...
  final bool isLast;
  const CustomListTile({super.key, this.title, this.onTap, this.isLast = false});
    ...
    return SingleChildScrollView(
      child: Container(
        decoration: BoxDecoration(
          ...
          border: isLast ? null : const Border(bottom: BorderSide(width: 1, color: AppColors.KASHMIR_COLOR)),
        ),
        child: ListTile(
          title: Text(
            title ?? '',
